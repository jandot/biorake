...
Even though the tests seem to run and I've tried some things out, I can't 
guarantee production-level stability (well: call it beta). Use at your own
risk.
...
_probes_ and _intensities_. (At the moment, you still have to create the 
database and tables beforehand, though. The same goes for the little database
with the meta table. There's a shell script that will do that for you, called 
